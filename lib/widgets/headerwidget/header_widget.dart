...
class Header extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // Instead of calling loadFirstName here, we ensure it's already loaded before the widget builds.
    return Obx(() {
      return Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      Padding(
                        ...
                        child: Text(
                          "Hi..\n${Fireauth.currentUser!.displayName ?? signupController.firstName.value}",
